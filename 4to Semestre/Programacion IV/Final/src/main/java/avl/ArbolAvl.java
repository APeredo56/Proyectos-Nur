...
public class ArbolAvl<E> extends AbbAbstracto<E> {
    ...
    public void dibujar(Graphics g, int ancho, int xActual, int yActual, NodoAvl<E> nodoActual) {
        int mitad = ancho / 2;
        int padding = 18;
        g.drawOval(
                xActual + mitad - NodoAvl.ancho / 2,
                yActual,
                NodoAvl.ancho,
                NodoAvl.ancho
        );
        g.drawString(
                ...
                xActual + mitad - (NodoAvl.ancho / 2) + padding,
                yActual + NodoAvl.ancho / 2
        );
        if (nodoActual.getDerecho() != null){
            dibujar(g, mitad, xActual + mitad, (int) (yActual + NodoAvl.ancho*1.5), nodoActual.getDerecho());
            g.drawLine(xActual + mitad, yActual + NodoAvl.ancho, xActual + mitad + mitad/2,
                    (int) (yActual + NodoAvl.ancho*1.5));
        }
        if (nodoActual.getIzquierdo() != null){
            dibujar(g, mitad, xActual, (int) (yActual + NodoAvl.ancho*1.5), nodoActual.getIzquierdo());
            g.drawLine(xActual + mitad,yActual + NodoAvl.ancho, xActual + mitad/2,
                    (int) (yActual + NodoAvl.ancho*1.5));
        }
    }
