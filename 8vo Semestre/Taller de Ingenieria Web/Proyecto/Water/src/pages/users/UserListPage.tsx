...
const TABLE_HEAD = ["Nombre", "Correo", "Rol", "", " "];
        ...
        <Card className="w-full my-8 !shadow-full-sm max-h-[75vh]">
            <CardHeader className="rounded-none p-4 m-0 flex flex-col justify-between md:flex-row md:items-center"
                ...
                <div className="flex flex-wrap sm:flex-nowrap w-full shrink-0 gap-2 md:w-max">
                    ...
                    <Button color="blue" onClick={() => navigate(Routes.USER.CREATE)}>
                        Agregar
                    </Button>
                </div>
            </CardHeader>
                    ...
                    <tbody>
                        {searchResults.map((user) => (
                            <tr key={user.id} className="even:bg-blue-gray-50/50">
                                ...
                                <td className="p-2">
                                    <Typography as="a" href={Routes.USER.EDIT_PARAM(user.id)} variant="small" color="white">
                                        <FontAwesomeIcon icon={faPen} className="h-4 w-4 rounded-full bg-blue-500 p-2" />
                                    </Typography>
                                </td>
                                <td className="p-2">
                                    <Button variant="text" color="white" onClick={() => handleDelete(user.id!)}>
